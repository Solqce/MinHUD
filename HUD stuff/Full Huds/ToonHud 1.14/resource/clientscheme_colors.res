Scheme
{
	...
	Colors
	{
		...
		"G_TransparentMenuBG"	"0 0 0 0" // Transparent menu color
		"G_PanelBg"				"40 40 40 196" // Panel color
		...
		"G_Overheal"			"50 205 50 255" // Overhealed health value color
		...
		"G_Killfeed_Base"			"0 0 0 107" // Killfeed Base color
		"G_Killfeed_Local"			"255 255 255 240" // Killfeed Local color
		...
		"G_FooterText"				"183 166 157 255" // Footer text color
		"G_DimmFooterText"			"183 166 157 120" // Dimm Footer text color
		"G_OuterBorder"				"0 0 0 255" // Outer border color
		"G_InnerBorder"				"255 255 255 64" // Inner border color
		...
		"G_MainMenuButton"			"40 69 120 255" // Main Menu button color
		"G_MainMenuButtonHover"		"64 107 184 255" // Main Menu hovered button color
		...
		"G_LoadoutItemBg"			"40 34 30 255" // Loadout item bg color
		"G_MenuBg"					"40 34 30 255" // Menu bg color
		"G_MenuText"				"183 166 157 255" // Menu text color
		"G_InputText"				"0 0 0 240" // Input text color
		"G_DimmInputText"			"0 0 0 100" // Dimm Input text color
		"G_DimmMenuText"			"183 166 157 120" // Dimm Menu text color
		"G_ItemDescriptionPanelBg"	"24 22 20 255" // Item description panel bg
		"G_ButtonBg"				"40 69 120 255" // Button bg color
		"G_ButtonText"				"213 202 202 255" // Button text color
		"G_ButtonHoverBg"			"23 40 71 255" // Button hover bg color
		"G_ButtonHoverText"			"202 193 193 255" // Button hover text color
		"G_ButtonSelectedBg"		"20 35 62 255" // Button selected bg color
		"G_ButtonSelectedText"		"119 111 111 255" // Button selected text color
		...
		"TFOrange"			"40 69 120 255" // Highlight color
		...
		"QualityColorNormal"					"197 197 197 255" // IQC Normal
		...
		"QualityColorUnique"					"128 128 128 255" // IQC Unique
		...
		"QualityColorStrange"					"212 69 69 255" // IQC Strange
		"QualityColorCompleted"					"134 80 172 255"
		"QualityColorHaunted"					"111 213 122 255" // IQC Haunted
		"QualityColorCollectors"				"170 0 0 255" // IQC Collectors
		"QualityColorPaintkitWeapon"			"250 250 250 255" // IQC PaintkitWeapon
		
		"DimmQualityColorNormal"				"197 197 197 100" // Dimm IQC Normal
		...
		"DimmQualityColorUnique"				"128 128 128 100" // Dimm IQC Unique
		...
		"DimmQualityColorStrange"				"212 69 69 100" // Dimm IQC Strange
		"DimmQualityColorCompleted"				"134 80 172 100"
		"DimmQualityColorHaunted"				"111 213 122 100" // Dimm IQC Haunted
	...
	BaseSettings
	{
		...
		Slider.NobColor				"40 69 120 255" // Highlight color
		Slider.TextColor			"183 166 157 255" // Menu text color
		Slider.TrackColor			"183 166 157 255" // Menu text color
		Slider.DisabledTextColor1	"183 166 157 120" // Dimm Menu text color
		Slider.DisabledTextColor2	"183 166 157 120" // Dimm Menu text color
